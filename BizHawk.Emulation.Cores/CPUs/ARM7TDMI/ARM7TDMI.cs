...
namespace BizHawk.Emulation.Common.Components.ARM7TDMI
{
	public sealed partial class ARM7TDMI
	{
		...
		public Func<uint, byte> ReadMemory;
		public Action<uint, byte> WriteMemory;
		public Func<uint, byte> PeekMemory;
		public Func<uint, byte> DummyReadMemory;

		//this only calls when the first byte of an instruction is fetched.
		public Action<uint> OnExecFetch;
		...
		(
			...
			Func<uint, byte> DummyReadMemory,
			Func<uint, byte> PeekMemory,
			Action<uint, byte> WriteMemory
		)
		{
